...
public static WebDriver driver;
	...
	
	{
		...
		click_element(driver,"id", "ctl00_MainContent_chkUserList_114");    // Minu Mishra
		
        Thread.sleep(1000);
		
		click_element(driver,"id", "ctl00_MainContent_chkUserList_179");    // Rupali Kadam
		...
		sendkeys(driver,"id","ctl00_MainContent_txtfilter", "minu");   // User
		...
		sendkeys(driver,"id", "ctl00_MainContent_txtfilter","Rupali");    // Rupali Kadam
...

	{
		...
		sendkeys(driver,"id","ctl00_MainContent_txtfilter", "Rupali");   // User
