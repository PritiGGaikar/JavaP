...
public void AddStatus(WebDriver driver1) throws Exception 
	
	{
        ...
        sendkeys(driver,"id","ctl00_MainContent_txtStatus", "Flying10");   // Status :(Dynamic)
		
		Thread.sleep(1000);
		
        sendkeys(driver,"id","ctl00_MainContent_txtValue", "Plane10");   // Value  (Dynamic)
	    ...
	    sendkeys(driver,"id","ctl00_MainContent_txtfilter", "Flying10");   // Filter(Dynamic)
...

{
    ...
    sendkeys(driver,"id","ctl00_MainContent_GridView_Status_ctl02_txtStatus_Name", "FlyingAway10");   //  Status edit(Dynamic)
	...
	sendkeys(driver,"id","ctl00_MainContent_txtfilter", "FlyingAway10");   // Filter(Dynamic)
...

{
    ...
    sendkeys(driver,"id","ctl00_MainContent_txtfilterCal_Status", "Flying10");   // Filter(Dynamic)
...

{
    ...
    sendkeys(driver,"id","ctl00_MainContent_GridView_Calc_Status_ctl02_txtEvaluation_Type", "FlyingAwayfrom10");   //  Status edit(Dynamic)
	...
	sendkeys(driver,"id","ctl00_MainContent_txtfilterCal_Status", "FlyingAwayfrom10");   // Filter(Dynamic)
