...
public static WebDriver driver;
	...
	
	{
        ...
        click_element(driver,"id", "ctl00_MainContent_chkJoiningType_0");   // Joining Type   abcd@123
		
		Thread.sleep(1000);
		
        click_element(driver,"id", "ctl00_MainContent_chkJoiningType_5");   // Joining Type  Sick Leave
      ...
      //  click_element(driver,"id", "ctl00_MainContent_chkJoiningType_6");   // Joining Type  Sick Leave
		...
		sendkeys(driver,"id","ctl00_MainContent_txtfilter", "FlyingAway1 ......./////");   // Status
